...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val journalButton=view.findViewById<ImageButton>(R.id.journalButton)
        ...
        homeNavController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                R.id.home_fragment -> {
                    ...
                    journalButton.setImageResource(R.drawable.journal_inactive)
                    myChambersButton.setImageResource(R.drawable.mychambers)
                    addChamberButton.visibility = View.GONE
                }
                R.id.journal_fragment -> { // replace with the actual ID of your new fragment
                    homeButton.isEnabled = true
                    journalButton.isEnabled = false
                    myChambersButton.isEnabled = true
                    homeButton.setImageResource(R.drawable.homeinactive)
                    journalButton.setImageResource(R.drawable.journal_active)
                    myChambersButton.setImageResource(R.drawable.mychambers)
                    addChamberButton.visibility = View.GONE
                }
            ...
            journalButton.setOnClickListener {
                ...
                homeNavController.navigate(R.id.journal_fragment)
            }
